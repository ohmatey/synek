...
src/
  ...
  routes/
    ...
    index.tsx                      home: the cinematic stories-first dashboard (ProjectRail ?project=slug filter + featured hero + story/timeline carousels); Landing for signed-out
  ...
  components/
    ...
    home/cinematic/                the stories-first home: ProjectRail, CinematicHero, HomeContentRow (carousels), StoryCard/TimelineCard, NewProjectDialog, MoveToProjectSubmenu
