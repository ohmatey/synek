...
const DEFAULT_MODEL = process.env.SYNEK_MODEL || 'anthropic/claude-sonnet-4-6'

export const IMAGE_MODEL_SLUG = process.env.SYNEK_IMAGE_MODEL || 'gpt-image-1'
...
export const STORY_MODEL_SLUG = process.env.SYNEK_STORY_MODEL || DEFAULT_MODEL
